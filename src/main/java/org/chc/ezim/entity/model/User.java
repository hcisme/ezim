...
public class User implements Serializable {
    ...
    public String toString() {
        return "用户id:" + (id == null ? "空" : id) + "，邮箱:" + (email == null ? "空" : email) + "，昵称:" + (nickName == null ? "空" : nickName) + "，0:女 1:男:" + (sex == null ? "空" : sex) + "，0:直接加入 1:同意后加好友:" + (joinType == null ? "空" : joinType) + "，密码:" + (password == null ? "空" : password) + "，个性签名:" + (personalSignature == null ? "空" : personalSignature) + "，状态:" + (status == null ? "空" : status) + "，创建时间:" + (createTime == null ? "空" : DateUtil.format(createTime, DateTimePatternEnum.YYYY_MM_DD_HH_MM_SS.getPattern())) + "，最后登录时间:" + (lastLoginTime == null ? "空" : DateUtil.format(lastLoginTime, DateTimePatternEnum.YYYY_MM_DD_HH_MM_SS.getPattern())) + "，地区:" + (areaName == null ? "空" : areaName) + "，地区代码:" + (areaCode == null ? "空" : areaCode) + "，最后离线时间:" + (lastOffTime == null ? "空" : lastOffTime);
    }
}
